  ...
  return (
    <div className="flex flex-col items-center md:h-full">
      ...
      <button
        ...
        className="mb-2 mt-6 dark:border mr-2 rounded-lg bg-gray-800 px-5 py-2.5 text-sm font-medium text-white hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700"
      >
        {isFetchingNextPage
          ? "Loading more..."
          : hasNextPage
