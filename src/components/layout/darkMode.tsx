...
const DarkMode = () => {
  ...
  return (
    <div className="m-2 flex h-[48px] w-[150px] items-center justify-center space-x-5 rounded-lg">
      <svg className="h-5 w-5 dark:text-white" xmlns="http://www.w3.org/2000/svg">
        <path
      ...
      <label className="relative inline-flex cursor-pointer items-center">
        <input type="checkbox" readOnly checked={darkMode} className="peer sr-only" />
        <div
          onClick={switchMode}
      ...
      <svg className="h-4 w-4 dark:text-white" xmlns="http://www.w3.org/2000/svg">
        <path
